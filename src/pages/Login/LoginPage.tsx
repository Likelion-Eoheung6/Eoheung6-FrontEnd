    ...
    loginMutation.mutate(
      { id: userId.trim(), password: password.trim() },
      {
        onError: (error: any) => {
          ...
          if (
            error.response?.data?.code === 'SIGNIN_400_1' ||
            error.response?.data?.code === 'SIGNIN_400_2'
          ) {
    ...
    <div className="relative mx-auto min-h-screen">
      ...
      <div className="absolute left-0 top-[137px] w-full flex flex-col items-center">
        ...
        <div className="mt-[20px] flex items-center justify-center text-[12px] font-medium leading-[1.2] tracking-[-0.025em] text-[rgba(84,84,84,1)]">
          <a
            href="#"
            className="align-middle no-underline text-[rgba(84,84,84,1)] visited:text-[rgba(84,84,84,1)] hover:no-underline"
          >
            아이디 찾기
          </a>
          <span
            aria-hidden
            className="mx-[15px] inline-block align-middle w-px h-[14px] bg-[rgba(255,239,161,1)]"
          ></span>
          <a
            href="#"
            className="align-middle no-underline text-[rgba(84,84,84,1)] visited:text-[rgba(84,84,84,1)] hover:no-underline"
