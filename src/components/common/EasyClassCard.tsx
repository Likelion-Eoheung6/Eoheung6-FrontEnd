...
export default function EasyClassCard({ 
  ...
  return (
    <div className="flex items-start gap-[9px]">
      ...
      {/* 클래스 카드 - 오른쪽 배치 */}
      <div 
        className="bg-[#FAFAFA] rounded-[20px] shadow-[0px_4px_4px_4px_rgba(0,0,0,0.04)] cursor-pointer hover:shadow-lg transition-shadow h-[96px] w-[244px] relative"
        onClick={onClick}
      >
        {/* 클래스 제목 */}
        <h3 className="absolute left-[9px] top-[10px] text-[#545454] text-[16px] font-medium leading-[120%] tracking-[-0.025em] overflow-hidden line-clamp-3">
          {title}
        </h3>

        {/* 참여 인원 */}
        <div className="absolute left-[122px] top-[58px] border border-[#E0E0E0] rounded-[20px] flex items-center pt-[6px] pb-[5px] px-[14px]">
