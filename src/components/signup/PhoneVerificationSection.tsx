...
const PhoneVerificationSection: React.FC<PhoneVerificationSectionProps> = ({
  ...
  // 인증 완료 성공메시지 생성
  const successMessage = isCodeVerified ? "인증이 완료되었습니다." : "";
  ...
  return (
    <>
      ...
      {/* 주의사항 */}
      <div className="flex items-start gap-[15px] py-[10px] pl-[23px] pr-[21px] bg-[#FDFDFD] border border-[#E0E0E0] rounded-[20px]">
