...
export default function KakaoLoginButton() {
  return (
    <div className="mt-[5px] flex items-center justify-center">
      <button
        type="button"
        className="relative rounded-[30px] bg-[#FEE102] shadow-[0_4px_4px_2px_rgba(0,0,0,0.04)] flex items-center justify-center gap-[5px] appearance-none border-0 outline-none focus:outline-none ring-0 focus:ring-0 cursor-pointer px-[84px] py-[14px]"
      >
